    ...
    return (
        <div className={`w-full h-fit ${isDarkmodeEnabled ? "bg-[#181A2A]" : "bg-white"}`}>
            ...
            <div className="h-fit my-20 flex justify-center items-center flex-col space-y-5">
                ...
                <h1 className={`text-4xl font-bold mb-16 ${isDarkmodeEnabled ? "text-white" : "text-[#232536]"}`} >Login</h1>
                ...
                <Link to={"/register"}> <button className={`text-sm  mr-103 underline cursor-pointer ${isDarkmodeEnabled ? "text-blue-400" : "text-blue-500"}`} >Don’t have an account?</button></Link>
